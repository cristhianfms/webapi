...
namespace Reports.DataAccess.Migrations
{
    ...
    [Migration("20190620183053_MyMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Reports.Domain.BoolValue", b =>
                {
                    b.HasBaseType("Reports.Domain.Value");

                    b.Property<bool>("Data");

                    b.HasDiscriminator().HasValue("BoolValue");
                });

            modelBuilder.Entity("Reports.Domain.DateValue", b =>
                {
                    b.HasBaseType("Reports.Domain.Value");

                    b.Property<DateTime>("Data")
                        .HasColumnName("DateValue_Data");

                    b.HasDiscriminator().HasValue("DateValue");
                });
